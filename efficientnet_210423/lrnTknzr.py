...
from efficientnet_210423.module.tokenizer import Tokenizer

tqdm.pandas()
import torch

from efficientnet_210423.module.conf.setting import INPUT, OUTPUT
...
def main():
    ...
    torch.save(tokenizer, OUTPUT + '/tokenizer/tokenizer2_pycharm.pth')
    ...
    train.to_pickle(OUTPUT + '/preprocessingTrain/train2_pycharm.pkl')
